...
const LocationDetailsPage = () => {
    ...
    const { src, title, text, info, rating = 0, review = 0 } = location.state || {};
        ...
        <div className="location_details">
            ...
            <div className="location_details_container">
                <div className="location_details_image">
                    <img src={src} alt={title || "No Image"} className="location_details_image_large" />
                </div>
            ...
            <div className="reservation_section">
                <div className="reservation_section_info">
                    ...
                    <div className="reservation_section_info_mid">
                        {[
                            { icon: HouseOutlinedIcon, title: "Entire home", desc: "You'll have the apartment to yourself" },
                            {
                                icon: AutoAwesomeOutlinedIcon,
                                title: "Enhanced Clean",
                                desc: "This Host committed to Airbnb's 5-step enhanced cleaning process. Show more",
                            },
                            { icon: DoorFrontOutlinedIcon, title: "Self check-in", desc: "Check yourself in with the keypad." },
                            { icon: CalendarTodayOutlinedIcon, title: "Free cancellation before Feb 14" },
